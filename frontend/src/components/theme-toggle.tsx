...
// Animated theme toggle (ported): a circular clip-path reveal expanding from the button
// center via the View Transitions API. Falls back to an instant switch where the API is
